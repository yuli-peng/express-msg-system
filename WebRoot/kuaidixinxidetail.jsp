...
<%
	...
	HashMap mqt = new CommDAO().getmap(id,"kuaidixinxi");
	//ldlbfz
     %>
<body>
...
<table width="1014" height="1056" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%'>运单号：</td><td width='39%'><%=mqt.get("yundanhao")%></td><td width='11%'>快件类型：</td><td width='39%'><%=mqt.get("kuaijianleixing")%></td></tr><tr><td width='11%'>源地址：</td><td width='39%'><%=mqt.get("yuandizhi")%></td><td width='11%'>目的地：</td><td width='39%'><%=mqt.get("mudedi")%></td></tr><tr><td width='11%'>收件人姓名：</td><td width='39%'><%=mqt.get("shoujianrenxingming")%></td><td width='11%'>收件人手机：</td><td width='39%'><%=mqt.get("shoujianrenshouji")%></td></tr><tr><td width='11%'>价格：</td><td width='39%'><%=mqt.get("jiage")%></td><td width='11%'>当前状态：</td><td width='39%'><%=mqt.get("dangqianzhuangtai")%></td></tr><tr><td width='11%'>备注：</td><td width='39%'><%=mqt.get("beizhu")%></td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()"  /></td></tr>
