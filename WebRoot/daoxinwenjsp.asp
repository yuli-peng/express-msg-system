...
<%
connstr="DRIVER={SQL Server};Server=.;UID=sa;PWD=sa123456;DATABASE=jspmkdgsglwzpjy52A9;"
...
<body>
<%
sql="select top 15  * from allgonggao where title like '%站%' or leibie like '%闻%' order by newid()"
